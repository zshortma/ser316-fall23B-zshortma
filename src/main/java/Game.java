...
public class Game {
    ...
    /**
     * Checks what positions a letter should be entered into and sets
     *  that value into the progress array.
     * @param letter
     */
    ...
    /**
     * Completely fills the progress with the answer. Returns 
     * the number of letters that were still unturned.
     */
     ...
     * Method checks if the guess is correct (letter in "answer" or complete word correct), 
     * should ignore upper/lowe case. Should set score based on if it was a letter or word
     *  guess and based on if it was correct or not 
     * If letter:
     *  Check that the letter is in the answer, if so turn that letter in the process variable
     *  If the letter is in the word more than once then turn all of them. For each correct 
     *  letter give +1 point, for an incorrect letter -1
     ...
     * @param choice takes in users choice 
     */
